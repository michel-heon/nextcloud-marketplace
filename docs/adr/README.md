# 📚 Architecture Decision Records (ADR) — nextcloud-marketplace

**Index central** de toutes les décisions architecturales du projet **nextcloud-marketplace**.

> Le projet vise à industrialiser et publier sur **Microsoft Azure Marketplace** une offre VM intégrant la solution open source **Nextcloud Hub** sur Azure, avec Nextcloud Hub, PHP, Nginx et MariaDB, destinée aux organisations souhaitant déployer un stockage cloud enterprise sur leur abonnement Azure.
...
| [001](./001-META-definition-projet-nextcloud-marketplace.md) | Définition et Cadrage du Projet nextcloud-marketplace | ✅ Accepté | 2026-04-01 | Gouvernance |
...
| [609](./609-DEVOPS-php-version-strategy.md) | Stratégie Version PHP pour Nextcloud Hub | ✅ Accepté | 2026-04-04 | DevOps |
...
| ADR | Titre | Statut | Date | Domaine |
|-----|-------|--------|------|---------|
| [700](./700-TEST-plan-tests-integration.md) | Plan de Tests d'Intégration — Nextcloud Marketplace | ✅ Accepté | 2026-05-12 | Test |
...
| `ARCH` | 100-199 | Architecture Nextcloud | 100 |
| `INFRA` | 200-299 | Azure VM, Packer, IaC | 201 |
| `SEC` | 300-399 | TLS, NSG, conformité Marketplace | 304 |
| `DATA` | 400-499 | Données Nextcloud, fichiers, metadata | 400 |
| `API` | 500-599 | API Nextcloud, intégrations | 500 |
